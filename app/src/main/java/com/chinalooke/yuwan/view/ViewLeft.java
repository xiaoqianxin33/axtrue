...
//		setBackgroundDrawable(getResources().getDrawable(R.drawable.choosearea_bg_mid));
        ...
        adapter = new TextAdapter(context, items, R.drawable.popback, R.drawable.choose_eara_item_selector);
