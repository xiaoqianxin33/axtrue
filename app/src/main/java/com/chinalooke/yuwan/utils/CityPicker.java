...
public class CityPicker extends LinearLayout {
	...
	//获取城市信息的接口
	private UpdateGetCity updateGetCity;

	public UpdateGetCity getUpdateGetCity() {
		return updateGetCity;
	}

	public void setUpdateGetCity(UpdateGetCity updateGetCity) {
		this.updateGetCity = updateGetCity;
	}
	...
	protected void onFinishInflate() {
		...
		System.out.println("===================="+citycodeUtil.getProvince(province_list));
		...
		provincePicker.setOnSelectListener(new ScrollerNumberPicker.OnSelectListener() {
			...
			public void endSelect(int id, String text) {
				...
				if(updateGetCity!=null){
					updateGetCity.updateCityInfo(text, UpdateGetCity.PROVINCE_ID);
				}
		...
		cityPicker.setOnSelectListener(new ScrollerNumberPicker.OnSelectListener() {
			...
			public void endSelect(int id, String text) {
				...
				if(updateGetCity!=null){
					updateGetCity.updateCityInfo(text, UpdateGetCity.CITY_ID);
				}
